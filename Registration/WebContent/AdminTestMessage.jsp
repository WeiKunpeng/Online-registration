...
<font size="4" color=blue>考生信息管理</font><br></br>
   ...
   <table align="center" width="400" height="400" border="1" style="position:fixed;top:30%;left:40%;">
   <tr> <td>考试编号</td><td><%=session.getAttribute("number")%></td> </tr>
   <tr> <td>考试科目</td><td><%=session.getAttribute("subject")%></td> </tr>
   <tr> <td>日期</td><td><%=session.getAttribute("date")%></td> </tr>
   <tr> <td>时间</td><td><%=session.getAttribute("time")%></td> </tr>
    <tr><td>地点</td>
